...
function locked_nav_javascript() {
  wp_enqueue_script( 'locked-nav-script', get_stylesheet_directory_uri() . '/js/locked_nav.js', array ('jquery' ));
}
add_action('wp_enqueue_scripts','my_custom_javascript');
add_action('wp_enqueue_scripts','locked_nav_javascript');
